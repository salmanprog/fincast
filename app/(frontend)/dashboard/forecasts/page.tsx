...
function DashboardForecastsList() {
  const { user } = useUser();
  ...
  const colCount = isAdminReporter ? 7 : 5;
                ...
                <TableRow key={r.id}>
                  ...
                  <TableCell className="py-3 text-theme-sm text-gray-600 dark:text-gray-400">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Link
                        href={`/dashboard/forecasts/${r.id}/pdf`}
                        target="_blank"
...
export default function UserDashboardForecastsPage() {
  useEffect(() => {
