...
export default function UserDashboardForecastPdfPage() {
  ...
  useEffect(() => {
    document.title = "FinCast | Forecast PDF";
  ...
  const handleDownloadPdf = useCallback(async () => {
    ...
    try {
      ...
      setPdfError(caught.message || "Could not generate PDF.");
    } finally {
